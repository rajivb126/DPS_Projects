...
function AddNewsletter() {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('newsletter_heading', Newsletter);
        formData.append('newsletter_link', newsletterLink);
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="row align-items-center">
                                    <div className="col-4 mb-4">
                                        <label>Newsletter Heading Name:</label>
                                    </div>
                                    <div className="col-8 mb-4">
                                        <input type="text" value={Newsletter} className='form-control' onChange={(e) => setNewsletter(e.target.value)} placeholder='Enter News Title' />
                                    </div>
                                    ...
                                    <div className='col-8 mb-4'>
                                        <input type="file" id="fileInput" onChange={(e) => setNewsletterLink(e.target.files[0])} />
                                    </div>
                                    ...
                                    <div className="col-12 text-center mt-5">
                                        <button type="submit" className="btn btn-primary w-50">Add Newsletter</button>
                                    </div>
                                </div>
                            </form>
